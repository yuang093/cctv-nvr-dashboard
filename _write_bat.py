...
RUN_WORKER = [
    ...
    b"",
    b"REM === Week 4 #011 \xe6\x95\x88\xe6\x9e\x9c\xe5\xae\x88\xe9\x96\x80\xef\xbc\x88\xe6\xaf\x8f\xe9\x80\xb1\xe6\x97\xa5\xe5\xa4\x9c\xe6\x9b\xb4 03:00 \xe6\x89\x8d\xe8\xb7\x91\xef\xbc\x89===",
    ...
    b")",
    b"",
    b"REM === Week 5 #015 audit log \xe6\x97\xa5\xe6\xaf\x8f 04:00 rotation ===",
    b'if "%HOUR%"==" 4" (',
    b"    echo [INFO] Week 5 #015 running audit log rotation at %date% %time%",
    b"    python scripts\\rotate_audit_log.py ^",
    b'        --db "%PROJECT_DIR%\\nvr_scan.db" ^',
    b'        --archive-dir "%PROJECT_DIR%\\archives\\audit" ^',
    b"        --retention-days 90",
    b"    if errorlevel 1 (",
    b"        echo [WARN] rotate_audit_log exit_code=%errorlevel%",
    b"    )",
    b")",
    b"",
